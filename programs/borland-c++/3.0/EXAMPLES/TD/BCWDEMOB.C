 ...
 *  Debugger for Windows. It contains a memory bug you can find     *
 *  using TDW and the chapter in the TD User's Guide that explains  *
 *  how to debug a Windows program. The original, bug-free version  *
 *  BCWDEMO.C, demonstrates how to write a simple Windows graphics  *
 *  program in Turbo C++.  It's called Simple Paint and provides    *
 *  three objects the user can draw, a line, an ellipse, and a      *
 *  rectangle.  Simple Paint also provides the user with three      *
 *  choices of line thicknesses and three choices of colors, red,   *
 *  green, and black.                                               *
 ********************************************************************/
